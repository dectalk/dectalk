...
U16 Lt_parse_string(GERLETTER *, U16, const LTrie *, U16 *,U16 *, U16 *,U16);
...
LTrie file2ltrie(CONST GERLETTER *, PhonemeWords *, const U16, int);
...
BOOL morphemize_word(const GERLETTER *, GERLETTER *, GERLETTER *, WalkCNTXT *, const wordgrammarinfo *);
