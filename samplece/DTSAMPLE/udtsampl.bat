...
rem set paths for DECtalk CE build

@echo build DTSample

set LIB=%DEVROOT%\WCE\lib\%PLATFORM%\WCEmips;%DEVROOT%\WCE\MFC\lib\%PLATFORM%\WCEmips;
nmake /f "uDtsampl.mak" CFG="Dtsample - Win32 (WCE MIPS) Release Dll" CESubsystem=windowsce,2.0 CEVersion=200 CEConfigName="H/PC Ver. 2.00"

set LIB=%DEVROOT%\WCE\lib\%PLATFORM%\WCEsh;%DEVROOT%\WCE\MFC\lib\%PLATFORM%\WCEsh;
nmake /f "uDtsampl.mak" CFG="Dtsample - Win32 (WCE SH) Release Dll" CESubsystem=windowsce,2.0 CEVersion=200 CEConfigName="H/PC Ver. 2.00"

set LIB=%SDKROOT%\WCE\lib\%PLATFORM%\HPC\x86em;%DEVROOT%\WCE\lib\%PLATFORM%\X86em;%DEVROOT%\WCE\MFC\lib\%PLATFORM%\X86em;
nmake /f "uDtsampl.mak" CFG="Dtsample - Win32 (WCE x86em) Release Dll" CESubsystem=windowsce,2.0 CEVersion=200 CEConfigName="H/PC Ver. 2.00"
