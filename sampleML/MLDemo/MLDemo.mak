...
!MESSAGE No configuration specified. Defaulting to MLDemo - Win32 ALPHA Debug.
!ENDIF 

!IF "$(CFG)" != "MLDemo - Win32 Release" && "$(CFG)" != "MLDemo - Win32 Debug" && "$(CFG)" != "MLDemo - Win32 ALPHA Release" && "$(CFG)" != "MLDemo - Win32 ALPHA Debug"
...
LINK32=link.exe
LINK32_FLAGS=..\..\dtalkml\alpha\release\dectalk.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\MLDemo.pdb" /machine:ALPHA /out:"$(OUTDIR)\MLDemo.exe" 
LINK32_OBJS= \
	"$(INTDIR)\MLDemo.res"
...
LINK32=link.exe
LINK32_FLAGS=..\..\dtalkml\alpha\debug\dectalk.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\MLDemo.pdb" /debug /machine:ALPHA /out:"$(OUTDIR)\MLDemo.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\MLDemo.res"
