...
#if 0
extern S16 r3cg=0;      /*  Gain factor for 3rd formant                        */
extern S16 r2cg=0;      /*  Gain factor for 2nd formant                        */
extern S16 r1cg=0;      /*  Gain factor for 1st formant                        */
extern S16 r5pc=0;      /*  "c" coefficient                                    */
extern S16 R5pb=0;      /*  "b" coefficient                                    */
extern S16 k1=0;        /*  Equals nopen1 for glottal period duration.         */
extern S16 k2=0;        /*  Equals nopen2 for glottal period duration.         */
extern S16 rnpb=0;      /*  "b" coefficient                                    */
extern S16 rnpc=0;      /*  "c" coefficient                                    */
extern S16 rlpa=0;      /*  "a" coefficient for low-pass filter                */
extern S16 rlpb=0;      /*  "b" coefficient                                    */
extern S16 rlpc=0;      /*  "c" coefficient                                    */
extern S16 R4cb=0;      /*  "b" coefficient                                    */
extern S16 R4cc=0;      /*  "c" coefficient                                    */
extern S16 R5cb=0;      /*  "b" coefficient                                    */
extern S16 R5cc=0;      /*  "c" coefficient                                    */
extern S16 R4pb=0;      /*  "b" coefficient                                    */
extern S16 r4pc=0;      /*  "c" coefficient                                    */
#endif
...
#ifdef EPSONC33
  AudioOutInit(&samplesEachPlay,8000,2);
#endif
  /********************************************************************/
