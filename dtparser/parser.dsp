...
# ADD CPP /nologo /W3 /GX /Ox /Ot /Oa /Ow /Og /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "PARSER_STANDALONE_DEBUG" /D "SINGLE_PRINT" /D "GERMAN_COMPOUND_NOUNS" /D "DISPLAY_RULES_TESTE" /D "DISPLAY_RULES_HIT" /FD /Zm200 /c
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "PARSER_STANDALONE_DEBUG" /D "DEBUG" /D "DEBUG2" /D "SANITY_CHECKING" /D "DISPLAY_RULES_HIT" /D "GERMAN_COMPOUND_NOUNS" /YX /FD /Zm200 /c
