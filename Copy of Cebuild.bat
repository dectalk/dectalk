...
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\us\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\us\access32\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\sp\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\sp\access32\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\la\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\la\access32\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\uk\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\uk\access32\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\fr\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\arm\fr\access32\dectalk.dll set bug_arm_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE ARM) Access32 German" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\arm\gr\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE ARM) Access32 German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\us\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\us\access32\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32 Spanish" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\sp\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 Spanish not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\sp\access32\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32 Latin American" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\la\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 Latin American not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\la\access32\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32 English UK" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\uk\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 English UK not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\mips\uk\access32\dectalk.dll set bug_mips_cedll=1
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE MIPS) Access32 French" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="HPC 2000"
if NOT exist ..\%build_wce_dll%\mips\fr\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 French not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
if NOT exist ..\%build_wce_dll%\mips\gr\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE MIPS) Access32 German not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
if NOT exist ..\%build_wce_dll%\x86\us\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 HPC 2000 Win32 (WCE x86) Access32 not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
...
rem mkdir .\samplece\windic\build\%PLATFORM%\2000
rem move .\samplece\windic\build\dll     .\samplece\windic\build\%PLATFORM%\2000
rem move .\samplece\windic\build\static  .\samplece\windic\build\%PLATFORM%\2000
...
nmake /NOLOGO /f "cedll.vcn" CFG="cedll - Win32 (WCE x86) Access32" CESubsystem=windowsce,3.00 CEVersion=300 CEConfigName="SMARTMEDIA"
if NOT exist ..\%build_wce_dll%\x86\us\access32\dectalk.dll echo Workspace %blddrv%%bldpath%\dapi\src\cedll.vcn wce300 SMARTMEDIA Win32 (WCE x86) Access32 not build >> %blddrv%%bldpath%\build_log\errors\win_ce%index%.log
if NOT exist ..\%build_wce_dll%\x86\us\access32\dectalk.dll set bug_x86_cedll=1
