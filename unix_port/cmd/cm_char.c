 ...
 * ---  ------	-----------	--------------------------------------------
 *	
 * 001	CJL		1/25/1996	Added comments to each entry for sanity.
 *                   		Updated MARKs for non-English chars.
 * 002	CJL		1/26/1996 	Corrected ASCII to ISO for > 7E.
 * 003	GL		2/01/1996   change 0xa1, 0xb7 and 0xbf to _punct
 * 004	EAB		2/02/1996  	add new table nchar_TYPE2s[] for Span Pre-processing.
 * 005	GL		2/12/1996   restore 0xdf to MARK_cons
