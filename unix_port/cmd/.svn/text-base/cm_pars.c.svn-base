...
/*#ifdef DTEX*/
						...
						if ((pKsd_t->sayflag == SAY_LETTER) && pCmd_t->bracket_space && (c == ' ') )
						{
 ...
 *
 */
static int cm_pars_icommand(PCMD_T pCmd_t)
{
 ...
 *
 */
static void OutputCharacter( LPTTS_HANDLE_T phTTS,unsigned char c )
{
  /*
