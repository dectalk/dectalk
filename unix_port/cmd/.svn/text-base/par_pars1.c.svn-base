...
int main(void)
{
	...
	{                                       			
		...
		*/
		...
		par_process_input(pKsd_t,input_array,new_input_array,output_array,dict_hit_array,input_indexes,new_input_indexes,output_indexes,0x00000004,0x00000020,0,0,&match_array,&ret_value);
		...
		par_process_input(pKsd_t,input_array,new_input_array,output_array,dict_hit_array,input_indexes,new_input_indexes,output_indexes,0x00000004,0x00000002,1,0,&match_array,&ret_value);
#ifndef SINGLE_PRINT
#ifndef NO_PRINT
		...
		par_process_input(pKsd_t,input_array,new_input_array,output_array,dict_hit_array,input_indexes,new_input_indexes,output_indexes,0x00000004,0x00000FFF,2,0,&match_array,&ret_value);
#ifndef NO_PRINT
		par_print_output(output_array,output_indexes);						/* print the results of the matching */
#endif
#endif
