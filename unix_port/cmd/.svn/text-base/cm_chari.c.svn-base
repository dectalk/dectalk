 ...
 * ---  ------	-----------	--------------------------------------------
 *	
 * 001	CJL		1/25/96		Added comments to each entry for sanity.
 *                   		Updated MARKs for non-English chars.
 * 002	CJL		1/26/96 	Corrected ASCII to ISO for > 7E.
 * 003	GL		2/01/96   	change 0xa1, 0xb7 and 0xbf to _punct
 * 004	EAB		2/02/96  	add new table nchar_types[] for Span Pre-processing.
 * 005	GL		2/12/96   	restore 0xdf to MARK_cons
 * 006	MGS		15-MAY-1996	Removed EAB's char_ntypes table
