 ...
 * ---	-----   -----------     --------------------------------------------
 * 001	gl		4/4/96			add debug command.   
 * 002  gl      8/1/96          change cmd_power() and cmd_version() to
 *                              cmd_cmd_power() and cm_cmd_version()
 * 003	gl		8/29/96			add skip command and skip option
 ...
 * 007  ncs     1/28/97         c_format field MUST be in quotes!!! (dtpc_command table)
