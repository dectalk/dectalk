...
void check_index( PKSD_T pKsd_t, unsigned int which_phone );
...
#if 0	//NCS: 05/01/97 Moved this up above comments
/* MVP : Not called anywhere :Comment it out
/**********************************************************************/
/**********************************************************************/
/*  Function: set_index_phone                                         */
/**********************************************************************/
/**********************************************************************/
void set_index_phone( PKSD_T pKsd_t,unsigned int nsym, unsigned int nphone )
{
  struct spc_packet _far *spc_pkt;
