...
extern void logclause (short *sym, short nsym, short *ud, short *uf0);
extern void logitem (register short *buf);
#else
extern void dologphoneme (LPTTS_HANDLE_T phTTS, short phone, short dur, short f0);
extern void logclause (LPTTS_HANDLE_T phTTS, short *sym, short nsym, short *ud, short *uf0);
...
extern void  setparam (PDPH_T pDph_t, int which, int value);
