 ...
 *  003 EAB		10/13/97	edited for UK
 *  004 EAB		12/12/97	add more code for UK
 *  005 EAB		3/31/98		Code had more locus types than need just causing confusion
				   ...
				   short shrink)
{
	...
	pDph_t->arg2 = shrink;
	halfmaxdur = mlsh1 (pDph_t->arg1, pDph_t->arg2);
	...
	pDph_t->arg1 = durin;
	durin = mlsh1 (pDph_t->arg1, pDph_t->arg2);
...
#endif /*#if defined ENGLISH || GERMAN */
