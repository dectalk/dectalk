...
/*  001	CJL		03/26/1997		Duplicate file; Replaced w/ \include */
/* MGS 07/28/1997 Added code for __osf__ build */
#ifdef __osf__
#include "../include/l_sp_ph.h" 
#else
#include "..\include\l_sp_ph.h" 
#endif
#if 0
...
#define PFSPAIN         0x1E                    /* spanish font 		*/ 
...
#define IS_MINUS ==0
#define SPAIN_FONT      (PFSPAIN << PSFONT)     /* Spanish font         */
...
#endif /* #if 0 * 001	CJL		03/26/1997		Duplicate file; Replaced w/ \include */
