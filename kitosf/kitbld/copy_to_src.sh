...
set COPY       = "cp -r"
set KITDEV     = $SOURCEBASE/kitosf/$OS_VER/DEV/src/usr/opt/DTKDEV460
...
$COPY $DOCS/txt/dtk_release_notes_dev.txt	$KITDEV/docs/ascii/dtk460_release_notes_dev.txt

$COPY $DOCS/ps/dtk_prog_guide.ps         $KITDEV/docs/postscript/dtk460_prog_guide.ps
$COPY $DOCS/txt/dtk_prog_guide.txt       $KITDEV/docs/ascii/dtk460_prog_guide.txt
$COPY $DOCS/pdf/dtk_prog_guide.pdf       $KITDEV/docs/pdf/dtk460_prog_guide.pdf
...
$COPY $DOCS/man/DTKMANDEV/whatis $KITDEV/share/man/.DTKMANDEV460.whatis
