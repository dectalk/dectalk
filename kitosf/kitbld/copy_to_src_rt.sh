...
set KITRT      = $SOURCEBASE/kitosf/$OS_VER/RT/src/usr/opt/DTKRT460
...
#
#$COPY $SOURCEBASE/dapi/build/dic/$OS_VER/us/release/userdict              $KITRT/tools/userdict_us
#$COPY $SOURCEBASE/dapi/build/dic/$OS_VER/uk/release/userdict              $KITRT/tools/userdict_uk
#$COPY $SOURCEBASE/dapi/build/dic/$OS_VER/sp/release/userdict              $KITRT/tools/userdict_sp
#$COPY $SOURCEBASE/dapi/build/dic/$OS_VER/gr/release/userdict              $KITRT/tools/userdict_la
#$COPY $SOURCEBASE/dapi/build/dic/$OS_VER/la/release/userdict              $KITRT/tools/userdict_gr
...
#
$COPY $SOURCEBASE/kitosf/ivp/DTKRT460.ivp               $KITRT/ivp/

#
#       Copy the on-line help
#
$COPY $DOCS/txt/filelist_rt.txt          $KITRT/docs/ascii/
$COPY $DOCS/txt/dtk_release_notes_rt.txt $KITRT/docs/ascii/dtk460_release_notes_rt.txt

$COPY $DOCS/txt/dtk_install_guide.txt	$KITRT/docs/ascii/dtk460_install_guide.txt
$COPY $DOCS/ps/dtk_install_guide.ps	$KITRT/docs/postscript/dtk460_install_guide.ps
$COPY $DOCS/pdf/dtk_install_guide.pdf	$KITRT/docs/pdf/dtk460_install_guide.pdf
$COPY $DOCS/ps/dtk_reference_guide.ps  $KITRT/docs/postscript/dtk460_reference_guide.ps
$COPY $DOCS/pdf/dtk_reference_guide.pdf  $KITRT/docs/pdf/dtk460_reference_guide.pdf
$COPY $DOCS/txt/dtk_reference_guide.txt $KITRT/docs/ascii/dtk460_reference_guide.txt
#
#      No Bookreader files this time around!!! V4.2A - Feb. 1996 
#
# $COPY $DOCS/book/dtk460_start.decw_book      $KITRT/lib/X11/help/
# $COPY $DOCS/book/dtk460_start.decw_bookshelf $KITRT/lib/X11/help/
#
#       Copy the on-line help
#
...
$COPY $DOCS/man/DTKMANRT/whatis               $KITRT/share/man/.DTKMANRT460.whatis
