...
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/ascii
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/postscript
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/pdf
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/man
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/man/man1
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/share/man/man1
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/docs/html


mkdir -p $KIT/RT/src/usr/opt/DTKRT460/examples/dtk/dtsamples
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/examples/dtk/speak/bitmaps

mkdir -p $KIT/RT/src/usr/opt/DTKRT460/lib/dtk
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/ivp
mkdir $KIT/RT/src/usr/opt/DTKRT460/shlib
mkdir $KIT/RT/src/usr/opt/DTKRT460/tools
#
# Create CDE directories
#
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/etc/dt
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/etc/dt/appconfig
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/etc/dt/appconfig/types/C
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/etc/dt/appconfig/icons/C
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/etc/dt/appconfig/appmanager/C/Multimedia

#
# Create Emacspeak directories
#
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/emacspeak/Macros
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/emacspeak/docs
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/emacspeak/docs/postscript
mkdir -p $KIT/RT/src/usr/opt/DTKRT460/emacspeak/docs/ascii
