...
echo "FR_udict:udict_fr.dic" >> /etc/DECtalk.conf
echo "GR_fdict:"$DICTIONARIES"/dtalk_fl_gr.dic" >> /etc/DECtalk.conf
...
say -a "DECtalk V5.00 has been successfully installed"
