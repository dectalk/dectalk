...
$
 * Revision 1.1.2.2  1995/11/14  21:34:48  Krishna_Mangipudi
 * 	Initial checkin into DECtalk Software source pool
 * 	[1995/11/14  21:33:43  Krishna_Mangipudi]
 *
 * $EndLog$
 */
struct ph_table_t {
...
extern struct ph_table_t  eng_ph_table[];
extern char *spnames[];
extern int sz_eng_ph_table;
