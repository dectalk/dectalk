...
rem ce_bld=ce must be set in order for CE to kit 
:checkit
if "%ce_bld%"=="ce" goto cebuild 
...
rem note platform is equal to a space
if "%bld_mach%"=="i386" set platform= 
if "%bld_mach%"=="i386" set arch_dir=swice
if "%bld_mach%"=="i386" set msdir=i386
...
md ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
...
if "%kitcopy_debug%"=="1" pause
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\mips
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\sh
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\x86em
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\mips\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\sh\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\x86em\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\res
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\mips\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\sh\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\x86em\%langdir%


if "%kitcopy_debug%"=="1" pause
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\x86em
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\arm
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\arm\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\x86em\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\res
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\bin\arm\%langdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\bin\x86em\%langdir%
...
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedisk1
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedisk2
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedisk3
...
if not "%bld_mach%"=="ALPHA" goto dirdone
...
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.h    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.c    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.cur    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.bmp    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.ico    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\udtsampl.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.rc    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\mips\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\mips\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\sh\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\sh\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\x86em\%langdir%\release\*.exe ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\x86em\%langdir%
if not errorlevel 0 goto error_end


if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.h    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.cpp    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\ucetalk.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.rc    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\res\*.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\res
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\%bld_path%\Wce200\dll\mips\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\mips\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\%bld_path%\Wce200\dll\sh\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\sh\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\%bld_path%\Wce200\dll\x86em\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\cetalk\bin\x86em\%langdir%
if not errorlevel 0 goto error_end


rem ce sample code Wce211
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.h    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.c    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.cur    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.bmp    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.ico    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\udtsampl.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\*.rc    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce211\dll\arm\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\arm\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce211\dll\x86em\%langdir%\release\*.exe ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\x86em\%langdir%
if not errorlevel 0 goto error_end


if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.h    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.cpp    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\ucetalk.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\*.rc    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\res\*.*    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\res
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\%bld_path%\Wce211\dll\arm\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\bin\arm\%langdir%
if "%ce_bld%"=="ce" copy ..\samplece\cetalk\%bld_path%\Wce211\dll\x86em\%langdir%\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\cetalk\bin\x86em\%langdir%
if not errorlevel 0 goto error_end
...
copy ..\samples\windic\*.c ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
copy ..\samples\windic\*.h ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
copy ..\samples\windic\*.def ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
copy ..\samples\windic\*.ico ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
copy ..\samples\windic\*.rc ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
copy ..\samples\windic\*.bmp ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
rem copy ..\samples\windic\uwindic.mak ..\%arch_dir%\%langdir%\install\data\as_is\samples\windic\%langdir%
...
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\mips\%langdir%\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\mips
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\mips\%langdir%\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\mips

if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\sh\%langdir%\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\sh
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\sh\%langdir%\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\sh

if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\x86em\%langdir%\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\x86em
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce200\cedll\x86em\%langdir%\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%langdir%\x86em

if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce211\cedll\arm\%langdir%\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\arm
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce211\cedll\arm\%langdir%\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\arm

if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce211\cedll\x86em\%langdir%\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\x86em
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\Wce211\cedll\x86em\%langdir%\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%langdir%\x86em

echo ***************************************************************
echo copy dictionary for for Wce
echo ***************************************************************
if "%ce_bld%"=="ce" copy ..\dapi\%bld_path%\dtalkdic\%langdir%\release\dectalk.dic ..\%arch_dir%\%langdir%\install\cedata\as_is\dtalk_%langdir%.dic

echo ***************************************************************
echo copy windic executable win95 for Wce user dictionary creator
echo ***************************************************************
if "%ce_bld%"=="ce" copy ..\samples\windic\%bld_path%\%langdir%\wdicstat\windic.exe ..\%arch_dir%\%langdir%\install\cedata\program\windic_%langdir%.exe
...
if "%ce_bld%"=="ce" copy ..\dapi\src\api\ttsapi.h ..\%arch_dir%\%langdir%\install\cedata\as_is\include
if "%ce_bld%"=="ce" copy ..\dapi\src\api\ttsfeat.h ..\%arch_dir%\%langdir%\install\cedata\as_is\include
...
if "%kitcopy_debug%"=="1" pause
copy ..\install\src\setup\smart.bmp ..\%arch_dir%\%langdir%\install\instdec
if not errorlevel 0 goto error_end
...
rem mfg if "%bld_mach%"=="ALPHA" goto a_split1
...
rem mfg copy ..\%arch_dir%\%langdir%\install\cesetup\dectalk.4 ..\%arch_dir%\%langdir%\install\cedisk4
rem mfg echo disk4 > ..\%arch_dir%\%langdir%\install\cedisk4\disk4.id

if NOT "%dtlang%"=="GERMAN" goto skipdisk4
if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\cesetup\dectalk.4 ..\%arch_dir%\%langdir%\install\cedisk4
if "%ce_bld%"=="ce" echo disk4 > ..\%arch_dir%\%langdir%\install\cedisk4\disk4.id 

if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\cesetup\dectalk.5 ..\%arch_dir%\%langdir%\install\cedisk5
if "%ce_bld%"=="ce" echo disk5 > ..\%arch_dir%\%langdir%\install\cedisk5\disk5.id 
...
if not errorlevel 0 goto error_end
if NOT "%bld_mach%"=="ALPHA" goto cp_txt3
...
rem if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\include
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedisk1
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cesetup

if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\mips
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\sh
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\x86em
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\mips\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\sh\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\x86em\%syslangdir%


if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\arm
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\x86em
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\arm\%syslangdir%
if "%ce_bld%"=="ce" md ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\x86em\%syslangdir%
...
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\x86em\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\x86em
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\x86em\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\x86em
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\sh\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\sh
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\sh\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\sh
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\mips\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\mips
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce200\mips\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\%syslangdir%\mips

if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce211\x86em\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\x86em
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce211\x86em\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\x86em
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce211\arm\release\dectalk.dll ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\arm
if "%ce_bld%"=="ce" copy ..\dtalkml\%bld_path%\Wce211\arm\release\dectalk.lib ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\%syslangdir%\arm
if not errorlevel 0 goto error_end

if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\mips\us\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\mips\%syslangdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\sh\us\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\sh\%syslangdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce200\dll\x86em\us\release\*.exe ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce200\samples\dtsample\bin\x86em\%syslangdir%

if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce211\dll\arm\us\release\*.exe    ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\arm\%syslangdir%
if "%ce_bld%"=="ce" copy ..\samplece\dtsample\%bld_path%\Wce211\dll\x86em\us\release\*.exe ..\%arch_dir%\%langdir%\install\cedata\as_is\Wce211\samples\dtsample\bin\x86em\%syslangdir%
...
if "%ce_bld%"=="ce" copy ..\install\src\setup\setup.rul ..\%arch_dir%\%langdir%\install\cesetup
if not errorlevel 0 goto error_end
copy ..\install\src\setup\setup.rul ..\%arch_dir%\%langdir%\install\setup
if not errorlevel 0 goto error_end
...
rem compile the install script..
if "%ce_bld%"=="ce" copy "%is3drv%%is3path%\program\compile.exe" ..\%arch_dir%\%langdir%\install\cesetup
if not errorlevel 0 goto error_end
if "%ce_bld%"=="ce" copy "%is3drv%%is3path%\program\packlist.exe" ..\%arch_dir%\%langdir%\install\cesetup
if not errorlevel 0 goto error_end
...
if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\idisk\*.* ..\%arch_dir%\%langdir%\install\cedisk1
if not errorlevel 0 goto error_end
if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\cesetup\setup.ins ..\%arch_dir%\%langdir%\install\cedisk1
if not errorlevel 0 goto error_end
if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\cesetup\setup.pkg ..\%arch_dir%\%langdir%\install\cedisk1
if not errorlevel 0 goto error_end
if "%ce_bld%"=="ce" copy ..\%arch_dir%\%langdir%\install\cesetup\dectalk.1 ..\%arch_dir%\%langdir%\install\cedisk1
echo disk1 > ..\%arch_dir%\%langdir%\install\cedisk1\disk1.id
if not errorlevel 0 goto error_end
