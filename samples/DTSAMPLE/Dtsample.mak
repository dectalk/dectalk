...
!IF "$(CFG)" != "Dtsample - Win32 Release" && "$(CFG)" != "Dtsample - Win32 Debug" && "$(CFG)" != "Dtsample - Win32 Release Access32" && "$(CFG)" != "Dtsample - Win32 Debug Access32" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static Spanish" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static German" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static Latin American" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static Spanish" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static German" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static Latin American" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static United Kingdom" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static United Kingdom" && "$(CFG)" != "Dtsample - Win32 Release Access32 Static French" && "$(CFG)" != "Dtsample - Win32 Debug Access32 Static French"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\..\dapi\src\api" /D "NDEBUG" /D "ACCESS32" /D "TYPING_MODE" /D "WIN32" /D "_WINDOWS" /D "FRENCH" /Fp"$(INTDIR)\Dtsample.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=..\..\dapi\build\dtstatic\fr\release\dtstatic.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib msvcrt.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\Dtaccess.pdb" /machine:I386 /out:"$(OUTDIR)\Dtaccess.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dtsample.obj" \
	"$(INTDIR)\dtaccess.res"
...
CPP=cl.exe
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\dapi\src\api" /D "_DEBUG" /D "ACCESS32" /D "TYPING_MODE" /D "WIN32" /D "_WINDOWS" /D "FRENCH" /Fp"$(INTDIR)\Dtsample.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
