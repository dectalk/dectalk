...
!MESSAGE No configuration specified. Defaulting to vercheck - Win32 ALPHA Debug.
!ENDIF 

!IF "$(CFG)" != "vercheck - Win32 Release" && "$(CFG)" != "vercheck - Win32 Debug" && "$(CFG)" != "vercheck - Win32 ALPHA Release" && "$(CFG)" != "vercheck - Win32 ALPHA Debug"
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\vercheck.pdb" /machine:ALPHA /out:"$(OUTDIR)\vercheck.exe" 
LINK32_OBJS= \
	"$(INTDIR)\VerCheck.res"
...
LINK32=link.exe
LINK32_FLAGS=/nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\vercheck.pdb" /debug /machine:ALPHA /out:"$(OUTDIR)\vercheck.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\VerCheck.res"
