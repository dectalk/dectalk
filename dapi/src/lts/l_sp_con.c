...
const unsigned char nwdtab[] = {
	...
	15,'m','i','l','l','ó','n',EOS,SP_M,SP_I,SBOUND,SP_LL,S1,SP_O,SP_N,SIL,
    ...
    15,'b','i','l','l','ó','n',EOS,SP_B,SP_I,SBOUND,SP_LL,S1,SP_O,SP_N,SIL,
	...
	17,'t','r','i','l','l','ó','n',EOS,SP_T,SP_R,SP_I,SBOUND,SP_LL,S1,SP_O,SP_N,SIL,
...
const unsigned char sdic[] = 
{
    ...
    20,'a','n','u','n','c','i','ó',EOS,SP_A,SBOUND,SP_N,SP_U,SP_N,SBOUND,SP_TH,SP_I,S1,SP_O,SPECIALWORD,SIL,
    ...
    22,'c','o','n','t','e','s','t','ó',EOS,SP_K,SP_O,SP_N,SBOUND,SP_T,SP_E,SP_S,SBOUND,SP_T,S1,SP_O,SPECIALWORD,SIL,
    ...
    21,'e','x','c','l','a','m','ó',EOS,SP_E,SP_K,SP_S,SBOUND,SP_K,SP_L,SP_A,SBOUND,SP_M,S1,SP_O,SPECIALWORD,SIL,
    ...
    19,'e','x','p','l','i','c','ó',EOS,SP_E,SP_K,SP_S,SBOUND,SP_P,SP_L,SP_I,SBOUND,SP_K,S1,SP_O,SPECIALWORD,SIL,
    ...
    22,'p','r','e','g','u','n','t','ó',EOS,SP_P,SP_R,SP_E,SBOUND,SP_G,SP_U,SP_N,SBOUND,SP_T,S1,SP_O,SPECIALWORD,SIL,
