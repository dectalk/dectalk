 ...
 *								created: SEP-30-1997
 * 0031 EAB		12/02/1997		Remove unused prdur calls-they're obsolete
 * 0032 EAB		12/12/1997		Some changes make it sound like British
 * 0033 EAB		05/11/1998		bats 660 ADD SLOWTALK
 * 0034 EAB 	02/02/1999		Moved break to get everything working properly
 * 0035 MGS		04/13/2000		Changes for integrated phoneme set 
 * 0036 EAB		06/28/2000		Unified Phoneme Set Changes
 * 0037 CAB		10/18/2000		Changed copyright info and removed page break
 * 0038 CAB		02/23/2001		Updated copyright info
 *
 *  
 */ 
...
//		if ((((struccur & FISBOUND) == FISBOUND) && nphon != 0 || nphon == pDph_t->nallotot - 2))
		if((struccur & FSTRESS_1) IS_PLUS)
			if((feasyllabiccur IS_PLUS) )
				//nal 8/1/00 kludge for testing first stressed 
		{
...
//break3:
		...
		if(phTTS->bInTypingMode == TRUE)
		{
			...
			{
				if(pDph_t->allophons[nphon] == UKP_S)
