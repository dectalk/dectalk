 ...
 ***********************************************************************
 *    Revision History:
 *	86 Michel  INITIAL VERSION FOR FRENCH
 * 001 07-05-92 Michel  Clean up file
 * 002 29-08-94 Michel  Reduce GF for feminine voices; need a femamp table
 *                      Michel  BR = 0 for test
 * 003 31-08-94 WIH     Added definitions for 8 kHz. sample rate.
 * 004 07-20-00	CHJ		Renamed from fphvdef.c to p_fr_vdf1.c, #include's updated. 8khz speaker defs
 *							are lies.
 * 005 09-20-00	CAB		Fixed copyright info and format revision section
 * 006 02-09-01 CAB		Added Michel changes for French
 8 007 4-6-01	eab		Check in french la change and verifry tuning fo 4.61
 */
...
short paul [SPDEF] = {
	...
	3850,   /* F8 (frequency in Hz of parallel 5th formant = F8) */
	  ...
	  18,   /* BF (baseline f0 fall in Hz) */
	   20,   /* LX (lax folds adjacent to voiceless sound -> breathiness) */
