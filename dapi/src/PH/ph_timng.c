...
static void init_timing (LPTTS_HANDLE_T phTTS)
{
...
#ifdef GERMAN
	pDph_t->timeref=13000/pKsd_t->sprate; //stressed timed language
	pKsd_t->sprate = pKsd_t->sprate - 10;
#endif
#ifdef SPANISH
	...
	pDph_t->timeref=6000/pKsd_t->sprate; //stressed timed language
#endif
...
extern short us_mindur[];
extern short gr_mindur[];
extern short la_mindur[];
extern short sp_mindur[];
extern short uk_mindur[];
extern short fr_mindur[];
...
{
extern short us_inhdr[];
extern short uk_inhdr[];
extern short gr_inhdr[];
extern short la_inhdr[];
extern short sp_inhdr[];
