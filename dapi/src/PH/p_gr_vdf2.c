 ...
 * 0030 EAB		3/30/98			Uncompleted changes for new GERMAN
 * 0031 JAW     04/27/1998      Added default glottal speeds.
 * 0032 EAB		4/27/98			Preliminary tune for GERMAN submission.
 * 0033 EAB		4/29/98			Fast manual tune for submission and wave file
								WARNING 8K VOICES ARE NOT TUNE AT ALL
 * 0034 EAB		4/29/98         Readjust some gains
 * 0035 EAB		6/3/98			Tuned 8K voices except for floating point model gain using cooledit
 ...
 * 0037 EAB		7/8/98		BATS 709-will all need gain adjust before ship
 * 0038 EAB		7/16/98			Gain adjust for rnd submital to Carl both 10kha and 8 khz, also move 
								new Frank voice that Oliver loves to 8KHZ.
 * 0039 EAB 		10/29/98 EAB Check in before over-writing with jeenny's new file as
			a backuo
...
short paul[SPDEF] =
{
	...
	65,								   /* GF (gain of frication source in dB) */
	59,								   /* GH (gain of aspiration source in dB) */
	76,								   /* GV (gain of voicing source in dB ) */
