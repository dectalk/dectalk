 ...
 * 003  EAB		7/9/98			Tuning Spanish with Juan
 * 004  EAB		7/20/98         copied from p_la_sr1.c after merge synchronization
 * 005  EAB		9/11/98			I can't make anysense of old BH code---modififed
 * 006  EAB		9/29/98 		Removed moronic rule.....
