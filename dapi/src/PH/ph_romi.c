 ...
 *							This is needed for phedit when complete no ifdef will be needed
							...
							for all languages. 
 *  005 EAB		07/14/98    For AD we've reached the point of no ifdef's required everything
							is to PHEDIT for rom code.
 *  006 EAB		07/20/98	Needs SPANISH_LA and SPANISH_SP to differentiate rom files.
 *  007 EAB 	10/11/00 	Merge Spaniush to one fbountab
 *  008 CAB		10/18/00	Changed copyright info and formatted comments
 */
