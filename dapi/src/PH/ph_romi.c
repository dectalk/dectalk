 ...
 *							This is needed for phedit when complete no ifdef will be needed
							...
							for all languages. 
 *  005 EAB		7/14/98     For AD we've reached the point of no ifdef's required everything
							is to PHEDIT for rom code.
 *  006 EAB		7/20/98		Needs SPANISH_LA and SPANISH_SP to differentiate rom files.
 */
