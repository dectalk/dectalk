 ...
 * 001	Michel	07-05-1992	Clean up file
 * 002	Michel	29-08-1994  	Reduce GF for feminine voices; need a femamp table
 * 003	Michel  		BR = 0 for test
 * 004	WIH	31-08-1994 	Added definitions for 8 kHz. sample rate.
 * 005  CAB	10-18-2000	Changed copyright info and formatted comments
 * 006 	CAB	01-17-00	Merged Michel Divay changes for French
 */
