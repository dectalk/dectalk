 ...
 *	016 EAB		1/10/98			Added length to f0_command for British Inotnation bats 575
    ...
    0021 EAB 7/13/98 BATS 711		Added number_vowels and increase feature bits array
	0022 EAb 1/25/99 Improved UK linkr in phsort code so that ends_in_r no_longer needed
    0023 EAB		2/3/99			Added change from NWSNOAA->NWS_US for multi language NOA
								also added openq variable but haven't decided how to ifdef them yet
								and variables for Evan Ballaban 
 *	0024 NAL 01/20/00			Added extern declarations for the tuned speaker param arrays
 *
 */
