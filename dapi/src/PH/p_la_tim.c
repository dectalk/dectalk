...
static short            con_4a_class[LAP_PH - LAP_WX + 1] =
{
	6, 6,							   /* WX YX                 	*/
...
{
	  /* 0 */ 
 {LAP_U, LAP_I, N97PRCNT, N92PRCNT, N100PRCNT, N90PRCNT},
	  /* 1 */ 
 {LAP_U, LAP_I, N100PRCNT, N87PRCNT, N100PRCNT, N90PRCNT},
	  /* 2 */ 
 {LAP_O, LAP_U, N115PRCNT, N80PRCNT, N90PRCNT, N97PRCNT},
	  /* 3 */ 
 {LAP_A, LAP_E, N115PRCNT, N120PRCNT, N97PRCNT, N107PRCNT},
	  /* 4 */ 
 {LAP_I, LAP_E, N110PRCNT, N82PRCNT, N90PRCNT, N97PRCNT},
	  /* 5 */ 
 {LAP_I, LAP_E, N115PRCNT, N80PRCNT, N100PRCNT, N90PRCNT},
	  /* 6 */ 
 {LAP_A, LAP_O, N95PRCNT, N105PRCNT, N100PRCNT, N87PRCNT}
};
