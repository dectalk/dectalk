 ...
 *  011 eab 	11/6/98   	BATS  807 Tuning for 5.0 release (hard coded levels)
    012 EAB		3/26/99 	BATS 878 Fixed the burst-plosive and plosive-plosive problem 
...
short uk_gettar (LPTTS_HANDLE_T phTTS, int nphone_temp)
{
	...
	if( PFUK != pDph_t->last_lang)
	{
		pDph_t->last_lang = PFUK;
