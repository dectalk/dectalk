 ...
 *                              and FFINALSYL.
 * 0010 EAB		2/16/99			Removed out_cb until and if we decide to model vocal chinks
#endif                  
#ifdef GERMAN
 ...
 * 054  EAB		2/3/99			Added change from NWSNOAA->NWS_US for multi language NOA plus new code for Evan Blalban
						and tuning of some values for new intonation
 * 055  eab     4/17/00 New_vocal_tract_nasal changes for 4.6 relelase
 055 EAB 2/23/99 Added new time define; updated copright and gov reg notice and  stop using asterixs on comments
 056 EAB 3/26/99 Added masks to support BATS 878 in p_us_st1
...
#define NASAL_ZERO_ALVELAR   1800
#else
#define NON_NASAL_ZERO 290
#define NASAL_ZERO_BOUNDARY 370
#define NASAL_ZERO_ALVELAR 400
#endif
