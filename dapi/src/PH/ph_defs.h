 ...
 * 063  EAB 	02/28/01 		Reduce question gest for german
 * 064  EAB	03/02/01 		Add ifdef to force 8khz
...
#define NON_NASAL_ZERO 500
#define NASAL_ZERO_BOUNDARY 550
#define NASAL_ZERO_CONS   1800
#else
#define NON_NASAL_ZERO 290
#define NASAL_ZERO_BOUNDARY 370
#define NASAL_ZERO_CONS 400
#endif //new_vocal_tract_nasal
//#else//else hlsyn
//#define NON_NASAL_ZERO  0
//#define NASAL_ZERO_BOUNDARY 25
//#define NASAL_ZERO_CONS 45
//#define NASAL_ZERO_VOWEL 25
//#endif //hlsyn
...
#ifdef NEW_VTM
#define VOICE_PARS	26			   /* EAB found looking for BAT3 667 this should
...
#ifdef GERMAN
#define NF_COMMA	47  //eab 10/17 300,600 per corine
#define NF_PERIOD	94
#endif
#ifdef NWS_US
#define NF_COMMA        60
...
#define OUT_GS	21 
 ...
 /* GS controls the glotal step making a much more sinusoidal       
 type excitation initially for nasals (especially German ones) */   
...
#define F0_QGesture1 281
#define F0_QGesture2 351
#define F0_CGesture1  160
#define F0_CGesture2  140
#define GEST_SHIFT 1
#define   MAX_NRISES  6
...
/*french stuff starts*/
/* features for French phonemes : featb array in phrom.c */
#define TSyllabique          FSYLL
#define TVoisee              FVOICD
#define TVoyelle             FVOWEL

#define TSonore              FSONOR
#define TFricative           0000010
#define TPlosive             FPLOSV
#define TNasale              FNASAL

#define TOcclusive           0000400
#define TArrondie            0001000
#define TFermee              0002000
#define TOuverte             0040000
//#define TSchwa               0010000
#define TGlide               0020000

//#define TLiquide             0040000
#define TLiqGli              0010000
#define TLaterale            0000040
#define N_PARAM              17  /* de 0 a 16 */

/* chj - these were never used anywhere */
/*
#define TAffriquee           0x00000100
#define TRelachee            0x00004000 
#define TFrontale            0x00008000
#define TF2Arriere           0x00010000
#define TAspiration          0x00100000
*/

/* chj - if these are needed most are in fr_place */
/*
#define TLabiale             0x00000200 //FLABIAL
#define TDentale             0x00000400 //FDENTAL
#define TAlveolaire          0x00000800 //FALVEL
#define TPalatale            0x00001000 //FPALATL
#define TPalatoAlveolaire    0x00002000
#define TVelaire             0x00004000 //FVELAR
#define TGlottale            0x00008000 //FGLOTTAL
*/


#ifdef FRENCH
//#define FMOT       0000004
//#define FGROU      0000010
//#define DERACC     0000040
//#define RAISE      0000400
//#define FSYNT      0004000
//#define ACCEN      0010000
//#define FPROP      0020000
//#define WBON       0x0100		//chj - never used
...
#define AT_TOP_OF_HAT             2
#define NORMAL                    1
#define HAT_LOCATIONS_SPECIFIED   2
#define HAT_F0_SIZES_SPECIFIED    3
#define SINGING                   4
#define PHONE_TARGETS_SPECIFIED   5


//#define FSTMARK              0x10000000

/* place of articulation : array place in phrom.c; used in phsettar.c */

#define VOICE_PARS           18  /* array parstochip */
#define SPDEF_PARS           22  /* nb of sp par. for the synthesizer */
#define NPHON_MAX            250 /* arrays allophons, ... */
#define SAFETY               32

#define DIV_BY8              >> 3 /* phdraw.c */

#define NSAMP_FRAME          64
#define MSTOFR(msec)         (((msec+4)*10)/NSAMP_FRAME)

#define IS_AV_OR_AH          ==0 /* phsettar.c */
#define IS_NASAL_ZERO_FREQ   ==1
#define IS_PARALLEL_FORM_AMP ==2
#define IS_FORM_FREQ         ==3
#define IS_FORM_BW           ==4
...
#define FRAC_ONE             16384
#define FRAC_HALF            8192
#define FRAC_3_4THS          12288
#define FRAC_3_HALVES        24567

/*
  Number of frames in xx milliseconds.  I.e., NF15MS is the number
  of synthesizer frames in 15 msec.
*/
#define NF7MS                1  /* phsettar.c */
#define NF15MS               2
#define NF20MS               3
#define NF25MS               4
#define NF30MS               5
...
#define NF_COMMA             3  /* nb frames : phtiming.c */
#define NF_PERIOD            75



#define R_PARAM              42  /* row number in tables */



#ifdef DEBG
  /* a framehas 17 entr‚es de 0 a 16  */
  /* NOM is the name of the phoneme for debugging */
#define NOM                17
#endif
