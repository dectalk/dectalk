 ...
 *  008     EAB		11/16/98		BATS 804 limit checking of internal speaker defs when
 ...
 *  009		EAB		02/18/99		Restructure to allow for new vdef files as needed
									Other chnages in DECTALKF.H
	010		EAB		03/19/99		Modified to suport tuning files for the nws build
	011		NAL		01/24/00		Modified to include vdf for tuned params for each lang
 */
