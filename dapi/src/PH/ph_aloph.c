 ...
 * 0035 EAB		1/12/99			Revised t->flap rule 
 * 0036 EAB		2/2/99 			Modified NWSNOAA to NWS_US for more languages for NOAA
 * 0036 EAB		2/2/99			Unrevised flap rule needs more study because it breaks words
								bigot shouldn't flap but other words ending  in t should
								so when to and when not to that is the question
 * 0037 EAB		321/00			Flap rule should be only after no-stress i.e. FTSRESS not FSTRESS_1
 */
/* #define MSDBG6 */
/* #define MSDBG7 */
