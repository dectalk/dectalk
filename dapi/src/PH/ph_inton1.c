 ...
 *`0030 EAB		6/28/98			Modified intonation per input from  Michael needs to be verified
								upon his return
 * 0031 EAB		7/14/98			BATS 713
 * 0032 EAB 	2/3/99			Added in changes for multi lang NWS_NOAA
 * 0033 EAb		6/7/99			BATS 897
 */
/* #define MSDBG4 */
