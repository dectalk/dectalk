...
/*  16. 26-MAY-97 EAB Fixed "poping problem see note in code		  
	...
	36  6/11/99 Modified overload calculation to check at the end of 
		the parallel tract as well as the cascade otherwise we don't 
		really know if we've overloaded(bug)
	37  When I relocated voice gain I had to if(avlind) the inclusion of 
		noise into the voicing source....
	38 /30/99 EAB Fixed setabc declaration -ifdef ou until and if we use the function
