 ...
 *
 * 0010 31-Mar-95 CJL   Rename this file from VIPHDEFS.H to VFPHDEFS.H,
 *                       add comments, add #define to exclude multiple includes.
 *                                                                             
 * 0011 16-JAN-96 SIK Removed white space inbetween # and include in places
 * 					  where #include is commented out.
 * 0012   ETT		10/05/1998      Added Linux code.
 */
