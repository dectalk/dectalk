 ...
 *  5	10/9/98	EAB added new variables for new ad stuff  
 *  6	28oct98	tek	add var to enable tuning taps 
 *  7   10nov98 ETT added Tom's compression define
 *  8   12nov98	ETT change vtm_fdef.h to vtm_f.h 
 *  09	12nov98	ETT fix include for osf. 
 *  10  19nov98	GL	BATS#826 define vtdTuneResults in FPVTM section
 *  11	25nov98 ETT	fixed comments for linux AGAIN
 *  12	Added new variables for upgrade code (UPGRADES1999)-not used yet
 *  13	1/19/99 EAB sgain for compression deinfed twice once within ifdef once outside 
 *				removed
 *
 *****************************************************************************************/
