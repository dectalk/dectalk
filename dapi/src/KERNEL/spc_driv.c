 ...
 ***********************************************************************
 *    Revision History:
 * 16jul95      ...tek          added hardw.h + related changes for dtpc2
 * 18jul95      ...tek          added load of DSP for dtpc2
 * 09aug95      ...tek          fix DSP DMA INT prio from DTPC1
 * 15spe95      ...jdb          replaced the dtpc1 calls to SAMPCLK and DSP
 *                               macros with new S_GPIO and C_GPIO macros from
 *                               hardw.h - fixes dtdemo speech.
 * 25oct95	...tek		file revert to remove 9/15/95 changes.
 * 14dec95	...tek		merge dtex
 * 26apr95	...tek		fix tone packet (hack) to make up for DSP fumble..
 * 19nov98	...tek		fix digitized mode to not hang when starved for data (NWS "buzz")
 */
