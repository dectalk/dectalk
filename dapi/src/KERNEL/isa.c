 ...
 ***********************************************************************
 *    Revision History:
 * 16 jul 95	...tek		added hardw.h for dtpcII + related changes
 * 09 aug 95	...tek		merge in the disable of IO_PRIORITY changes,
 *				change of dma_task prio from DTPC1
 * 31 oct 95	...tek		change dma_task to prio 3 to get rid of
 *				dtdemo sluggishness on DTPC1
 * 06nov95	...tek		add FLUSH_type_char subcode
 * 31 jan 96	...tek		merge DTEX (ser_cmd.c)
 */
