 ...
 *  012     ETT     05oct98         added linux code
...
extern void cm_util_type_out(PKSD_T pKsd_t, unsigned int c);
extern int 	cm_util_string_match(unsigned char *sa[],unsigned char *s);
