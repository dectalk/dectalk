 ...
 *
 *                           Copyright ©
 *    Copyright © 2000 Force Computers, Inc., a Solectron Company. All rights 
 ...
 * 063	MFG		02/28/2003		Merged in DECtalk version 5.00 changes
 */
...
*/
				  ...
				  (c != 0xaa && c != 0xba))
							...
							/* GL 12/17/1998 BATS#846 say_fletter to skip control character */
							case SAY_FLETTER:
								if (c >= 32) cm_util_type_out(pKsd_t, c);
								break;
