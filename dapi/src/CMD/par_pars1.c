...
extern int noun_num_character_in_mapping;
extern int noun_character_mapping_table[];
extern int noun_number_of_conjunctions;
extern comp_noun_conjunction noun_conjunction[];
extern int noun_index_table[];
extern char noun_data_table[];
#endif
