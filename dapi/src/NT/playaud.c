 ...
 * 020	mfg		12/14/1999	fix starteam screwup
 ) 021	MGS		6/13/2003	Merged audio device reset code.
 *
 */
/**********************************************************************/
/*                                                                    */
...
/* TQL 05/21/1997  change this for OSF build */
  ...
  {
	  UINT uiStutterMinWrite = (0.065) * (double)pWaveFormat->nAvgBytesPerSec;
