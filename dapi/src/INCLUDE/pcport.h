 ...
 * 21apr97      ...GL           BATS#360  remove spaces before "#define" or "#if" 
 * 25sep97      ...GL           change the dictionary pointer structure to support
 *                              UK_english and language expansion and add "lang" item for
 *                              PKT_set_dic and dma_set_dic data structure.
 * 22jun98		mfg     Added LANG_latin_american support
 * 10/05/1998   ETT     Added Linux code.
 */
