 ...
 * 035	MFG		02/27/2003		Merged in DECtalk version 5.00 changes
 ********************************************************************/
 ...
 */
	...
	volatile		HANDLE fdicMapObject[MAX_languages];		// Handle for dictionary mapped object
	volatile		HANDLE fdicFileHandle[MAX_languages];		// File Handle for mapped dictionary	
	volatile		LPVOID fdicMapStartAddr[MAX_languages];	// Starting address of mapped dictionary view

	volatile		HANDLE foreigndicMapObject[MAX_languages];		// Handle for dictionary mapped object
	volatile		HANDLE foreigndicFileHandle[MAX_languages];		// File Handle for mapped dictionary	
