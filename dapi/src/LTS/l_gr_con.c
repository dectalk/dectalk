 ...
 * 008  EAB		3/13/00			Change ig suffix from ch->k (CH is entirely wrong 
								it must be SH or K)
...
unsigned char p20[]    = {
	TS,	V,     S1,      A,      N,   MBOUND, TS,       I,       K,
	SIL
};

unsigned char p30[]    = {
	D,     RR,      S1,     EI,  MBOUND, S,        I,       K,
	SIL
};

unsigned char p40[]    = {
	F,     S1,      I,      R,   MBOUND, TS,       I,       K,
	SIL
};
...
unsigned char p60[]    = {
	Z,     S1,      E,      CH,  MBOUND, TS,       I,       K,
	SIL
};

unsigned char p70[]    = {
	Z,     S1,      I,      P,   MBOUND, TS,       I,       K,
	SIL
};

unsigned char p80[]    = {
	Q,     S1,      A,      KH,  MBOUND, TS,       I,       K,
	SIL
};

unsigned char p90[]    = {
	N,     S1,      EU,     N,   MBOUND, TS,       I,       K,
	SIL
};
