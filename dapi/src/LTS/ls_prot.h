...
#ifdef SPANISH
extern  void ls_proc_do_2_digits(LPTTS_HANDLE_T phTTS,LETTER *lp);
extern  void ls_proc_do_3_digits(LPTTS_HANDLE_T phTTS,LETTER *lp); // NAL warning removal
#endif // SPANISH
#if defined (ENGLISH) || defined (GERMAN)
extern  void ls_proc_do_3_digits(LPTTS_HANDLE_T phTTS,LETTER *lp);
#endif
#ifndef FRENCH
extern  void ls_proc_do_4_digits(LPTTS_HANDLE_T phTTS,LETTER *lp); // NAL warning removal
#endif
#ifdef ENGLISH
