...
unsigned char m_feb[] = "fev";
unsigned char m_mar[] = "mar";
unsigned char m_apr[] = "avr";
unsigned char m_may[] = "mai";
unsigned char m_jun[] = "jun";
unsigned char m_jul[] = "jui";
unsigned char m_aug[] = "aou";
...
unsigned char une[]     = { F_U, F_N, EOS };
unsigned char francs[]  = { F_F, F_R, F_AN, EOS };
unsigned char heure[]   = { F_O6, F_R, EOS };
unsigned char pminus[]  = { F_M, F_W, F_IN, EOS };
unsigned char ptiret[]  = { F_T, F_I, F_R, F_E2, EOS };
unsigned char phalf[]   = { F_D, F_E, F_M, F_I, EOS };
unsigned char ptiers[]  = { F_T, F_Y, F_E2, F_R, EOS };
unsigned char pquart[]  = { F_K, F_A, F_R, EOS };
unsigned char pcent[]   = { F_S, F_AN, EOS };
unsigned char pdegree[] = { F_D, F_E, F_G, F_R, F_E1, EOS };
unsigned char dizieme[] = { F_D, F_I, F_Z, F_Y, F_E2, F_M, EOS };

unsigned char p0[] = { F_Z, F_E1, F_R, F_AU, EOS };
unsigned char p1[] = { F_UN, EOS };
unsigned char p2[] = { F_D, F_EU, EOS };
unsigned char p3[] = { F_T, F_R, F_W, F_A, EOS };
unsigned char p4[] = { F_K, F_A, F_T, F_R, EOS };
unsigned char p5[] = { F_S, F_IN, F_K, EOS };
unsigned char p6[] = { F_S, F_I, F_S, EOS };
unsigned char p7[] = { F_S, F_E2, F_T, EOS };
unsigned char p8[] = { F_WU, F_I, F_T, EOS };          /* without a T ??? : 7, 8, 9 */

unsigned char p9[] = { F_N, F_O6, F_F, EOS };
...
unsigned char p0l[] = { F_Z, F_E1, F_R, F_AU, EOS };
unsigned char p1l[] = { F_U, F_N, EOS };            /* feminine */
unsigned char p2l[] = { F_D, F_EU, F_Z, EOS };
unsigned char p3l[] = { F_T, F_R, F_W, F_A, F_Z, EOS };
unsigned char p4l[] = { F_K, F_A, F_T, F_R, EOS };
unsigned char p5l[] = { F_S, F_IN, F_K, EOS };
unsigned char p6l[] = { F_S, F_I, F_Z, EOS };
unsigned char p7l[] = { F_S, F_E2, F_T, EOS };
unsigned char p8l[] = { F_WU, F_I, F_T, EOS };
unsigned char p9l[] = { F_N, F_O6, F_V, EOS };

unsigned char *punitsl[] = {
  p0l,  p1l,    p2l,    p3l,    p4l,
  p5l,  p6l,    p7l,    p8l,    p9l
};

unsigned char pmillion []  = { F_M, F_I, F_L, F_Y, F_ON, EOS };
unsigned char pthousand [] = { F_M, F_I, F_L, EOS };
unsigned char phundred []  = { F_S, F_AN, EOS };
unsigned char ieme []      = { F_Y, F_E2, F_M, EOS};
unsigned char premier []   = { F_P, F_R, F_E, F_M, F_Y, F_E1, EOS};
unsigned char premiere []  = { F_P, F_R, F_E, F_M, F_Y, F_E2, F_R, EOS};

unsigned char p10[] = { F_D, F_I, F_S, EOS };
unsigned char p11[] = { F_ON, F_Z, EOS };
unsigned char p12[] = { F_D, F_OU, F_Z, EOS };
unsigned char p13[] = { F_T, F_R, F_E2, F_Z, EOS };
unsigned char p14[] = { F_K, F_A, F_T, F_O, F_R, F_Z, EOS };
unsigned char p15[] = { F_K, F_IN, F_Z, EOS };
unsigned char p16[] = { F_S, F_E2, F_Z, EOS };
unsigned char p17[] = { F_D, F_I, F_S, F_S, F_E2, F_T, EOS };
unsigned char p18[] = { F_D, F_I, F_Z, F_WU, F_I, F_T, EOS };
unsigned char p19[] = { F_D, F_I, F_Z, F_N, F_O6, F_F, EOS };
...
unsigned char pnone[] = { EOS };

unsigned char p20t[] = { F_V, F_IN, F_T, EOS };
unsigned char p20[]  = { F_V, F_IN, EOS };
unsigned char p30[]  = { F_T, F_R, F_AN, F_T, EOS };
unsigned char p40[]  = { F_K, F_A, F_R, F_AN, F_T, EOS };
unsigned char p50[]  = { F_S, F_IN, F_K, F_AN, F_T, EOS };
unsigned char p60[]  = { F_S, F_W, F_A, F_S, F_AN, F_T, EOS };
unsigned char p70[]  = { F_S, F_W, F_A, F_S, F_AN, F_T, F_D, F_I, F_S, EOS };
unsigned char p80[]  = { F_K, F_A, F_T, F_R, F_E, F_V, F_IN, EOS };
unsigned char p90[]  = { F_K, F_A, F_T, F_R, F_E, F_V, F_IN,
        F_D, F_I, F_S, EOS };
...
unsigned char ppercent[] = { WBOUND, F_P, F_OU, F_R, F_S, F_AN, EOS };
unsigned char pand[]     = { WBOUND, F_E1, WBOUND, EOS };
unsigned char ppoint[]   = { F_P, F_W, F_IN, WBOUND, EOS };
unsigned char ptt2tp[]   = { WBOUND, F_F, F_W, F_A, F_D, F_I, F_S, WBOUND,
            F_A, F_L, F_A, WBOUND,
            F_P, F_WU, F_I, F_S, F_AN, F_S, WBOUND, EOS };

unsigned char pjan[]  = { F_J, F_AN, F_V, F_Y, F_E1, EOS};
unsigned char pfeb[]  = { F_F, F_E1, F_V, F_R, F_I, F_Y, F_E1, EOS};
unsigned char pmar[]  = { F_M, F_A, F_R, F_S, EOS};
unsigned char pavr[]  = { F_A, F_V, F_R, F_I, F_L, EOS};
unsigned char pmai[]  = { F_M, F_E2, EOS};
unsigned char pjuin[] = { F_J, F_WU, F_IN, EOS};
unsigned char pjui[]  = { F_J, F_WU, F_I, F_Y, F_E2, EOS};
unsigned char paou[]  = { F_OU, F_T, EOS};
unsigned char psep[]  = { F_S, F_E2, F_P, F_T, F_AN, F_B, F_R, EOS};
unsigned char poct[]  = { F_O, F_K, F_T, F_O, F_B, F_R, EOS};
unsigned char pnov[]  = { F_N, F_AU, F_V, F_AN, F_B, F_R, EOS};
unsigned char pdec[]  = { F_D, F_E1, F_S, F_AN, F_B, F_R, EOS};
...
char cat_div[] = {
  3, 'à', EOS,                      11,     /* a2 */
  4, 'ç', 'a', EOS,                     CgDivers,      /* c5a */
  9, 'é', 't', 'a', 'i', 'e', 'n', 't', EOS,    CgVA,   /* e1taient */
  7, 'é', 't', 'a', 'i', 's', EOS,      CgVA,
  7, 'é', 't', 'a', 'i', 't', EOS,      CgVA,
  7, 'é', 't', 'i', 'e', 'z', EOS,      CgVA,
  8, 'é', 't', 'i', 'o', 'n', 's', EOS,     CgVA,
  6, 'ê', 't', 'e', 's', EOS,               CgVA,   /* e3tes */
  EOS
};
...
unsigned char p0th[] = { F_Z, F_E1, F_R, F_AU, F_Y, F_E2, F_M, EOS };
unsigned char p1th[] = { F_U, F_N, F_Y, F_E2, F_M, EOS };
unsigned char p2th[] = { F_D, F_EU, F_Z, F_Y, F_E2, F_M, EOS };
unsigned char p3th[] = { F_T, F_R, F_W, F_A, F_Z, F_Y, F_E2, F_M, EOS };
unsigned char p4th[] = { F_K, F_A, F_T, F_R, F_Y, F_E2, F_M, EOS };
unsigned char p5th[] = { F_S, F_IN, F_K, F_Y, F_E2, F_M, EOS };
unsigned char p6th[] = { F_S, F_I, F_Z, F_Y, F_E2, F_M, EOS };
unsigned char p7th[] = { F_S, F_E2, F_T, F_Y, F_E2, F_M, EOS };
unsigned char p8th[] = { F_WU, F_I, F_T, F_Y, F_E2, F_M, EOS };
unsigned char p9th[] = { F_N, F_O6, F_V, F_Y, F_E2, F_M, EOS };
