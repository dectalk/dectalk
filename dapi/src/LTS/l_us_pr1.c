 ...
 * 010  EAB     11/21/97        EAB BATS 266 remove "19xx" expansion 
 * 011  GL		10/21/98		BATS#770 support eurpose date reading under mode_europe 
 * 012	MGS		11/23/1998		BATS #329 fixed 02-apr-2001 
 * 013  EAB 2/2/99 Fixed BATS 863 which corrected the number before 
