 ...
 * 010 	CAB		10/18/00		Changed copyright info
 */
...
static  short syllfeatb[PHO_SYM_TOT] = {
      /* [ SIL ]  */   0,
      /* [ LA_A ]  */   VOWEL                  ,
      /* [ LA_E ]  */   VOWEL                  ,
      /* [ LA_I ]  */   VOWEL   | HIGH               ,
...
static PHONE * l_sp_ad1_onset(PHONE* wstart, PHONE* endp)
{
   ...
   {
      if (prev->p_phone == LA_P && prev != wstart && l_sp_ad1_sonset(prev))
	  { 
   ...
   {
      if (prev->p_phone == LA_T && l_sp_ad1_sonset(prev))
