 ...
 *  011 EAB		9/29/98	 EAB		Added a variable
 ...
 *  015 EAB		2/2/99 Fixed BATS 863 which corrected the number before 
...
extern  unsigned char pcomma[];  /* "comm" */
