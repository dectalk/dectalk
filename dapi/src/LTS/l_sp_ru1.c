...
static  char fonemequiv[] = {
      /* @ .. G */   SP_NH,   SP_A,   SP_B,   NOVALID,SP_D,   SP_E,   SP_F,   NOVALID,
      /* H .. O */   NOVALID,SP_I,   SP_J,   SP_K,   SP_L,   SP_M,   SP_N,   SP_O,
      /* P .. W */   SP_P,   NOVALID,NOVALID,NOVALID,SP_T,   NOVALID,SP_V,   NOVALID,
      /* X .. Z */   NOVALID,SP_Y,   SP_TH,   NOVALID,NOVALID,NOVALID,NOVALID,NOVALID
      };
