...
#define DICT_ACCESS(x)       ((struct dic_entry *)(&(pKsd_t->fdic_data[DICT_LANG][pKsd_t->fdic_index[DICT_LANG][(x)]])))
#define FDICT_ACCESS(x)      ((struct dic_entry *)(&(pKsd_t->foreigndic_data[DICT_LANG][pKsd_t->foreigndic_index[DICT_LANG][(x)]])))
#define UDICT_ACCESS(x)      ((struct dic_entry *)(&(pKsd_t->udic_data[DICT_LANG][pKsd_t->udic_index[DICT_LANG][(x)]])))
#define ADICT_ACCESS(x)      ((struct dic_entry *)(&(pKsd_t->adic_data[DICT_LANG][pKsd_t->adic_index[DICT_LANG][(x)]])))
