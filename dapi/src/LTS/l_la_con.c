...
unsigned char nwdtab[] = {
	...
	15,'m','i','l','l','ó','n',EOS,LA_M,LA_I,SBOUND,LA_LL,S1,LA_O,LA_N,SIL,
    ...
    15,'b','i','l','l','ó','n',EOS,LA_B,LA_I,SBOUND,LA_LL,S1,LA_O,LA_N,SIL,
	...
	17,'t','r','i','l','l','ó','n',EOS,LA_T,LA_R,LA_I,SBOUND,LA_LL,S1,LA_O,LA_N,SIL,
...
unsigned char sdic[] = 
{
    ...
    20,'a','n','u','n','c','i','ó',EOS,LA_A,SBOUND,LA_N,LA_U,LA_N,SBOUND,LA_TH,LA_I,S1,LA_O,SPECIALWORD,SIL,
    ...
    22,'c','o','n','t','e','s','t','ó',EOS,LA_K,LA_O,LA_N,SBOUND,LA_T,LA_E,LA_S,SBOUND,LA_T,S1,LA_O,SPECIALWORD,SIL,
    ...
    21,'e','x','c','l','a','m','ó',EOS,LA_E,LA_K,LA_S,SBOUND,LA_K,LA_L,LA_A,SBOUND,LA_M,S1,LA_O,SPECIALWORD,SIL,
    ...
    19,'e','x','p','l','i','c','ó',EOS,LA_E,LA_K,LA_S,SBOUND,LA_P,LA_L,LA_I,SBOUND,LA_K,S1,LA_O,SPECIALWORD,SIL,
    ...
    22,'p','r','e','g','u','n','t','ó',EOS,LA_P,LA_R,LA_E,SBOUND,LA_G,LA_U,LA_N,SBOUND,LA_T,S1,LA_O,SPECIALWORD,SIL,
...
unsigned char spwhword[] = {
	...
	8,      'q', 'u', 'é', EOS, LA_K,S1,LA_E,SIL,
	8,      'q', 'u', 'e', EOS,LA_K,SEMPH,LA_E, SIL,
	6,      'c', 'u', 'á','l', EOS, SIL,
...
unsigned short featb_sp_lts[PHO_SYM_TOT] = {
      /* [ SIL ]  */      FSONOR,
