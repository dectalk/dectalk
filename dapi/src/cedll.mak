...
!IF "$(CFG)" != "cedll - Win32 (WCE MIPS) Release" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Debug" && "$(CFG)" != "cedll - Win32 (WCE x86em) Release" && "$(CFG)" != "cedll - Win32 (WCE x86em) Debug" && "$(CFG)" != "cedll - Win32 (WCE SH3) Release" && "$(CFG)" != "cedll - Win32 (WCE SH3) Debug" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Release Spanish" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Release English UK" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Release German" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Release Latin American" && "$(CFG)" != "cedll - Win32 (WCE SH3) Release Spanish" && "$(CFG)" != "cedll - Win32 (WCE SH3) Release Latin American" && "$(CFG)" != "cedll - Win32 (WCE SH3) Release English UK" && "$(CFG)" != "cedll - Win32 (WCE SH3) Release German" && "$(CFG)" != "cedll - Win32 (WCE x86em) Release Latin American" && "$(CFG)" != "cedll - Win32 (WCE x86em) Release English UK" && "$(CFG)" != "cedll - Win32 (WCE x86em) Release German" && "$(CFG)" != "cedll - Win32 (WCE ARM) Release" && "$(CFG)" != "cedll - Win32 (WCE ARM) Release Spanish" && "$(CFG)" != "cedll - Win32 (WCE ARM) Release German" && "$(CFG)" != "cedll - Win32 (WCE ARM) Release Latin American" && "$(CFG)" !=\
 "cedll - Win32 (WCE ARM) Release English UK" && "$(CFG)" != "cedll - Win32 (WCE SH4) Release" && "$(CFG)" != "cedll - Win32 (WCE SH4) Release German" && "$(CFG)" != "cedll - Win32 (WCE SH4) Release English UK" && "$(CFG)" != "cedll - Win32 (WCE SH4) Release Spanish" && "$(CFG)" != "cedll - Win32 (WCE SH4) Release Latin American" && "$(CFG)" != "cedll - Win32 (WCE ARM) Access32" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Access32" && "$(CFG)" != "cedll - Win32 (WCE SH3) Access32" && "$(CFG)" != "cedll - Win32 (WCE SH4) Access32" && "$(CFG)" != "cedll - Win32 (WCE x86em) Access32" && "$(CFG)" != "cedll - Win32 (WCE ARM) Access32 English UK" && "$(CFG)" != "cedll - Win32 (WCE ARM) Access32 German" && "$(CFG)" != "cedll - Win32 (WCE ARM) Access32 Latin American" && "$(CFG)" != "cedll - Win32 (WCE ARM) Access32 Spanish" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Access32 English UK" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Access32 German" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Access32 Spanish" && "$(CFG)" != "cedll - Win32 (WCE MIPS) Access32 Latin American" && "$(CFG)" != "cedll - Win32 (WCE SH3) Access32 English UK" && "$(CFG)" != "cedll - Win32 (WCE SH3) Access32 German" && "$(CFG)"\
 != "cedll - Win32 (WCE SH3) Access32 Latin American" && "$(CFG)" != "cedll - Win32 (WCE SH3) Access32 Spanish" && "$(CFG)" != "cedll - Win32 (WCE SH4) Access32 English UK" && "$(CFG)" != "cedll - Win32 (WCE SH4) Access32 German" && "$(CFG)" != "cedll - Win32 (WCE SH4) Access32 Latin American" && "$(CFG)" != "cedll - Win32 (WCE SH4) Access32 Spanish" && "$(CFG)" != "cedll - Win32 (WCE ARM) Debug" && "$(CFG)" != "cedll - Win32 (WCE x86em) Release Spanish"
...
!MESSAGE "cedll - Win32 (WCE ARM) Debug" (based on "Win32 (WCE ARM) Dynamic-Link Library")
...
OUTDIR=.\..\build\cedll\mips\debug\release
INTDIR=.\..\build\cedll\mips\debug\release\link

ALL : "..\build\cedll\mips\us\debug\dectalk.dll"
...
CLEAN :
	...
	-@erase "..\build\cedll\mips\us\debug\dectalk.dll"
	-@erase "..\build\cedll\mips\us\debug\dectalk.ilk"
...
PFILE=pfile.exe
CPP=clmips.exe
CPP_PROJ=/nologo /M$(CECrtMT) /W3 /Zi /Od /I ".\ce" /I ".\acna" /I ".\api" /I ".\cmd" /I ".\lts" /I ".\ph" /I ".\vtm" /I ".\kernel" /I ".\nt" /I ".\include" /I ".\protos" /I "..\.." /D "DEBUG" /D "MIPS" /D "_MIPS_" /D "$(CEConfigName)" /D "ENGLISH" /D "ENGLISH_US" /D UNDER_CE=$(CEVersion) /D _WIN32_WCE=$(CEVersion) /D "UNICODE" /D "_USRDLL" /D "BLD_DECTALK_DLL" /D "WIN32" /Fp"$(INTDIR)\cedll.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /QMRWCE /c 
...
LINK32=link.exe
LINK32_FLAGS=commctrl.lib coredll.lib /nologo /entry:"_DllMainCRTStartup" /base:"0x10000000" /dll /incremental:yes /pdb:"$(OUTDIR)\dectalk.pdb" /debug /machine:MIPS /nodefaultlib:"$(CENoDefaultLib)" /def:".\dectalk.def" /out:".\..\build\cedll\mips\us\debug/dectalk.dll" /implib:"$(OUTDIR)\dectalk.lib" /subsystem:$(CESubsystem) 
DEF_FILE= \
	".\dectalk.def"
LINK32_OBJS= \
	"$(INTDIR)\cm_char.obj" \
...
"..\build\cedll\mips\us\debug\dectalk.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.\..\build\cedll\sh3\us\debug
INTDIR=.\..\build\cedll\sh3\us\debug\link
# Begin Custom Macros
OutDir=.\..\build\cedll\sh3\us\debug
# End Custom Macros
...
PFILE=pfile.exe
CPP=shcl.exe
CPP_PROJ=/nologo /M$(CECrtDebug) /W3 /Zi /Od /I ".\ce" /I ".\acna" /I ".\api" /I ".\cmd" /I ".\lts" /I ".\ph" /I ".\vtm" /I ".\kernel" /I ".\nt" /I ".\include" /I ".\protos" /I "..\.." /D "DEBUG" /D "SHx" /D "SH3" /D "_SH3_" /D "$(CEConfigName)" /D "ENGLISH" /D "ENGLISH_US" /D UNDER_CE=$(CEVersion) /D _WIN32_WCE=$(CEVersion) /D "UNICODE" /D "_USRDLL" /D "BLD_DECTALK_DLL" /D "WIN32" /Fp"$(INTDIR)\cedll.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /c 
...
!ELSEIF  "$(CFG)" == "cedll - Win32 (WCE ARM) Debug"

OUTDIR=.\..\build\cedll\arm\us\debug\link
INTDIR=.\..\build\cedll\arm\us\debug\link
...
CPP=clarm.exe
CPP_PROJ=/nologo /MC /W3 /Zi /Od /I ".\ce" /I ".\acna" /I ".\api" /I ".\cmd" /I ".\lts" /I ".\ph" /I ".\vtm" /I ".\kernel" /I ".\nt" /I ".\include" /I ".\protos" /I "..\.." /D _WIN32_WCE=$(CEVersion) /D "$(CEConfigName)" /D "DEBUG" /D "ARM" /D "_ARM_" /D UNDER_CE=$(CEVersion) /D "UNICODE" /D "ENGLISH" /D "ENGLISH_US" /D "_USRDLL" /D "BLD_DECTALK_DLL" /D "WIN32" /Fp"$(INTDIR)\cedll.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /c 
...
LINK32=link.exe
LINK32_FLAGS=coredll.lib commctrl.lib /nologo /entry:"_DllMainCRTStartup" /base:"0x10000000" /align:"4096" /dll /incremental:yes /pdb:"$(OUTDIR)\dectalk.pdb" /debug /machine:ARM /nodefaultlib:"$(CENoDefaultLib)" /def:".\dectalk.def" /out:".\..\build\cedll\mips\us\debug/dectalk.dll" /implib:"$(OUTDIR)\dectalk.lib" /subsystem:$(CESubsystem) 
DEF_FILE= \
	".\dectalk.def"
LINK32_OBJS= \
	"$(INTDIR)\cm_char.obj" \
...
LINK32=link.exe
LINK32_FLAGS=commctrl.lib coredll.lib /nologo /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\dectalk.pdb" /machine:I386 /def:".\dectalk.def" /out:"$(OUTDIR)\dectalk.dll" /implib:"$(OUTDIR)\dectalk.lib" /windowsce:emulation 
DEF_FILE= \
	".\dectalk.def"
LINK32_OBJS= \
	"$(INTDIR)\cm_char.obj" \
