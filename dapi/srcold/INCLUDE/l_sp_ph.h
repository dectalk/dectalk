 ...
 *
 *                           Copyright ©
 *    Copyright © 2000,2001 Force computers Inc., a Solectron company. All rights reserved.*    © Digital Equipment Corporation 1995. All rights reserved.
 *
 ...
 * 002	MGS		06/17/1998		Added code for PHEDIT2
 * 003	GL		09/01/1998	    BATS#758 change PFSPAIN to PFSP.
 * 004	MGS		12/27/1999		Fix for SAPI
 * 005 	CAB		10/18/00		Changed copyright info
 * 006	CAB		09/04/01		Added #error
 */ 
...
#define NOVALID                 (TOT_ALLOPHONES+ 0)     /* Used by parser, etc. */
#else
...
#define IS_MINUS ==0
#define SPAIN_FONT      (PFSP << PSFONT)     /* Spanish font         */
#define SPAIN(ph)       (SPAIN_FONT | (ph))     /* Phone in Spanish     */
...
// 004	MGS		12/27/1999		Fix for SAPI
//#define LANGUAGE        L_SPAIN
  
#endif /* #ifndef L_SP_PHH */
