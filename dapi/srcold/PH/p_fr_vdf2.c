 ...
 * 002	Michel	07-05-92	Clean up file
 * 003	Michel	29-08-94   	Reduce GF for feminine voices; need a femamp table
 * 004	Michel  			BR = 0 for test
 * 005	WIH		31-08-94 	Added definitions for 8 kHz. sample rate.
 * 006	CAB		10-18-00	Changed copyright info
 * 007	CAB		08-31-01	Added ifdef NEW_PHONES
 */
...
short paul [SPDEF] = {
	MALE,   /* SEX = m */
		...
		73,   /* GH (gain of aspiration source in dB) */
...
short betty[SPDEF] = {
	FEMALE,   /* SEX = f */
		...
		72,   /* GF was 72 (gain of frication source in dB) */
...
short frank[SPDEF] = {
	MALE,   /* SEX = m */
		...
		72,   /* E: 68 GF (gain of frication source in dB) */
		70,   /* GH (gain of aspiration source in dB) */
...
short kit[SPDEF] = {
	FEMALE,   /* SEX = f */
		...
		ZAPF,   /* F8 (frequency in Hz of parallel 5th formant = F8) */
		73,   /* GF was 72 (gain of frication source in dB) */
		70,   /* GH (gain of aspiration source in dB) */
		65,   /* GV (gain of voicing source in dB ) */
