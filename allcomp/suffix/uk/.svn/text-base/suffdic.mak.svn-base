...
ALL : "$(OUTDIR)\suffdic_uk.exe"

CLEAN : 
	-@erase ".\Debug\vc40.pdb"
	-@erase ".\Debug\vc40.idb"
	-@erase ".\Debug\suffdic_uk.exe"
	-@erase ".\Debug\Toph.obj"
	-@erase ".\Debug\Suffdic.obj"
	-@erase ".\Debug\suffdic_uk.ilk"
	-@erase ".\Debug\suffdic_uk.pdb"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /out:"Debug/suffdic_uk.exe"
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/suffdic_uk.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/suffdic_uk.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Toph.obj" \
	"$(INTDIR)/Suffdic.obj"

"$(OUTDIR)\suffdic_uk.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
