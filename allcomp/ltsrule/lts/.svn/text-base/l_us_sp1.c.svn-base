 ...
 *                                                                       
 *********************************************************************** 
 *    File Name:	l_us_sp1.c
 *    Author:		Matthew Schnee                                         
 *    Creation Date:02/06/96                                                   
 *                                                                             
 *    Functionality:                                                           
 *    The language dependent spell vs. speak include file for english                                                                           
 *                                                                             
 ***********************************************************************       
 *                                                                             
 * Rev	Who		Date			Description                    
 * ---	-----	-----------		---------------------------------------
 * 001	DR	07/21/1997		Should not have #ifdef ENGLISH_US removed it      
 * 002	MGS	04/11/2002		ARM7 port
 * 
 */
...
#endif                   
extern const unsigned char spell_it[26][26];
#ifdef OS_PALM
