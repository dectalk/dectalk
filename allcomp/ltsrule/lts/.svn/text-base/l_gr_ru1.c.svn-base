 ...
 * 010	MGS		05/09/2001	Warning removal
 * 011	MGS		02/25/2002	Removed unused index code
 */
			...
			switch (lch)
            {
				case '\'': 
                    if (ls_rule_add_graph(pLts_t,gp1, GGQUOTE,0) != FALSE)
						++gp1;
                    break;                        
                case '+':        /* added by REWT: void filtering out MORPHEME markers generated by BACHUS */
					if  (ls_rule_add_graph(pLts_t,gp1, GGMBOUND,0) != FALSE)
						++gp1;
                    break;    
                case '=':        /* added by REWT to let through also SYLLABLE markers generated by BACHUS */
					if  (ls_rule_add_graph(pLts_t,gp1, GGSYLBOUND,0) != FALSE)
						++gp1;
                    break;    
				case '@':	      /* Matt's THINGY's 1-9 follow here: additional grapheme symbols for LTS */
                  if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY1,0) != FALSE)
						++gp1;
                    break;       
				case '!':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY2,0) != FALSE)
						++gp1;
                    break;       
				case '$':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY3,0) != FALSE)
						++gp1;
                    break;       
				case '%':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY4,0) != FALSE)
						++gp1;
                    break;       
				case '^':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY5,0) != FALSE)
						++gp1;
                    break;       
				case '*':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY6,0) != FALSE)
						++gp1;
                    break;       
				case '&':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY7,0) != FALSE)
						++gp1;
                    break;       
				case ':':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY8,0) != FALSE)
						++gp1;
                    break;       
				case '~':
                    if (ls_rule_add_graph(pLts_t,gp1, GGTHINGY9,0) != FALSE)
						++gp1;
                    break;       					
...
#ifdef REWT_DOES_LIKE_THIS__NOT              /* NO "GGQU" replacement REWT */
