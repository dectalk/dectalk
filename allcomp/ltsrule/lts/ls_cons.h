...
#else
extern const unsigned char *const months[];
#endif
...
#else
extern const unsigned char *const punits[];
#endif
//BATS 863
#ifdef OS_PALM
extern const unsigned char * upunits[];
#else
extern const unsigned char *const upunits[];
#endif
...
#else
extern const unsigned char *const pteens[];
#endif
...
#else
extern const unsigned char *const ptens[];  
#endif
#ifdef ITALIAN
#ifdef OS_PALM
extern const unsigned char * ptens_x[];  
#else
extern const unsigned char *const ptens_x[];  
#endif
extern const unsigned char p2x[];
extern const unsigned char p3x[];
extern const unsigned char p4x[];
extern const unsigned char p5x[];
extern const unsigned char p6x[];
extern const unsigned char p7x[];
extern const unsigned char p8x[];
extern const unsigned char p9x[];
#endif
...
#else
extern const unsigned char *const pmonths[];
#endif
...
#else
extern const unsigned char *const pordin[];
#endif
...
#else
extern const unsigned char *const punitsl[];
#endif
extern const unsigned char heure[];
#ifdef OS_PALM
extern const unsigned char * categ[];
#else
extern const unsigned char *const categ[];
#endif
...
#ifdef ACNA
#ifdef OS_PALM
extern const unsigned char acna_lsbtab[];
#else
extern const unsigned char far acna_lsbtab[];
#endif //OS_PALM
#ifdef OS_PALM
extern const U16 acna_lswtab[];
#else
...
#else
extern const unsigned char *const ounits[];
#endif
...
#else
extern const unsigned char *const oteens[];
#endif
...
#else
extern const unsigned char *const otens[]; 
#endif
...
#else
extern  const unsigned char *const upunits[];
extern  const unsigned char *const pordunits[];
extern  const unsigned char *const pordtens[];
extern  const unsigned char *const pordteens[];
#endif
