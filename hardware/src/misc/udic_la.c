 ...
 *    Revision History:
 *
 * 001	MFG		06/24/1998	Copied from udic_uk.c then modified to support Latin American
 * 002	tek		31mar99		remove ptab, it is now in phonlist.h
 *							(for userdic integration)
 * 003	GL 		07/07/1999  add ,issing "^" at the end of table as udic_sp.c
 * 004	NAL		24apr00		Changes for integrated phoneme set
...
unsigned char   la_arpa[] = {	/*Latin American arpabet*/
