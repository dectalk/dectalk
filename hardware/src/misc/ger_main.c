 ...
 */
	...
	nlt.link = NULL_LT;
	nlt.lang_id = LANG_german;

	nlt.lang_ascky = german_ascky;
	nlt.lang_ascky_size = sizeof(german_ascky);
	nlt.lang_reverse_ascky = german_ascky_rev;
	nlt.lang_arpabet = german_arpa;
	nlt.lang_arpa_size = sizeof(german_arpa);
	nlt.lang_arpa_case = FALSE;
	nlt.lang_typing =	german_type;
	nlt.lang_error = german_error;
 ...
 */
	...
	default_lang(LANG_german,LANG_tables_ready);
}
