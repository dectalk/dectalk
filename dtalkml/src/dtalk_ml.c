 ...
 * mgs	27mar2001	Added TextToSpeechVisualMarks (doesn't work properly yet)s
 *
 **********************************************************************/
...
unsigned int load_dectalk(char *lang) {
	...
	(VOID (_cdecl*)())funcs->TextToSpeechReserved2 = (void ((_cdecl*)())) GetProcAddress(funcs->mod,TEXT("TextToSpeechReserved2"));
