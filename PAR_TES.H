...
int rule_sections[2]={	0,	18	};

int num_rules=64;

rule_t rule_table[64] = {
{	0,	-1,	0xFFFF,	0x0003,	 0,	 0,	-1,	-1,	15,	-1,	"W~<+>'.'d/E<1>/E<1>"	},
{	0,	-1,	0xFFFF,	0x0003,	 1,	 0,	-1,	-1,	-1,	-1,	"W~<+>d/E<1>/E<1>"	},
{	0,	-1,	0xFFFF,	0x0003,	 2,	 0,	-1,	-1,	-1,	-1,	"W~<+>E<1>d/P<*>/"	},
{	0,	-1,	0xFFFF,	0x0003,	90,	 0,	-1,	-1,	-1,	-1,	"W~<+>d/P<1>/E<1>"	},
{	0,	-1,	0xFFFF,	0x0003,	 3,	 0,	-1,	-1,	-1,	-1,	"W~<*>($1,P<1>)d/$1/W~<*>"	},
...
{	0,	-1,	0xFFFF,	0x0004,	 7,	14,	-1,	-1,	-1,	-1,	"a/E<1>/0x0B/W~<*>"	},
{	0,	-1,	0xFFFF,	0x0004,	91,	14,	-1,	-1,	-1,	-1,	"a/P<1>/' '/W~<*>"	},
{	0,	-1,	0xFFFF,	0x0004,	 8,	 0,	-1,	-1,	-1,	-1,	"a/W~<*>/' '/P<1>W~<*>"	},
{	0,	-1,	0xFFFF,	0x0002,	 9,	14,	-1,	-1,	-1,	-1,	"a/T<1>/' '/W~<*>"	},
{	0,	-1,	0xFFFF,	0x0002,	10,	 0,	-1,	-1,	-1,	-1,	"a/W~<*>/' '/T<1>W~<*>"	},
{	0,	-1,	0xFFFF,	0x0001,	11,	13,	-1,	-1,	-1,	-1,	"W~<*>r/T<+>/' '/W~<*>"	},
{	1,	0,	0x0000,	0x0000,	12,	 0,	 0,	 0,	 0,	 0,	""	},
{	0,	-1,	0xFFFF,	0x0003,	101,	17,	16,	-1,	-1,	-1,	"W~<+>E~<*>'.'h/1,E<1>/r/$7/$9/|FAIL/"	},
{	2,	0,	0x0000,	0x0000,	102,	 0,	 0,	 0,	 0,	 0,	""	},
{	1,	0,	0x0000,	0x0000,	103,	 0,	 0,	 0,	 0,	 0,	""	},
...
{	0,	-1,	0x7FFF,	0x7FFF,	38,	-1,	-1,	-1,	-1,	-1,	"r/'D'`r.`/'Doctor'/r/W<1-3>/' '/c/S{U<1>L<+>,U<*>}<1>/"	},
{	0,	-1,	0x7FFF,	0x7FFF,	39,	-1,	-1,	-1,	-1,	-1,	"r/'S'`t.`/'Saint'/r/W<1-3>/' '/c/S{U<1>L<+>,U<*>}<1>/"	},
{	0,	-1,	0xFFFF,	0xFFFF,	41,	52,	-1,	-1,	-1,	 0,	"H<3-20>r/'.'/' dot '/i/S{O<1>V<1>O<1>,A<1>H<0-2>}<1>/''|' '/"	},
{	0,	-1,	0x7FFF,	0x7FFF,	42,	-1,	-1,	-1,	-1,	-1,	"a/D<1-4>/'th'|'st'|'nd'|'rd'|'th'|'th'|'th'|'th'|'th'|'th'/r/W<1-4>/' '/S{`st.`,`ave.`,`dr.`}<1>"	},
...
{	0,	-1,	0x7FFF,	0x7FFF,	50,	52,	-1,	62,	-1,	-1,	"a/D<+>/' '/A<+>r/'-'/' dash '/H<+>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	51,	52,	-1,	63,	-1,	-1,	"a/A<+>/' '/D<+>r/'-'/' dash '/H<+>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	52,	52,	-1,	60,	-1,	-1,	"a/A<+>/' '/D<1-6>o/'.'D<1-4>/D~<0-1>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	53,	52,	-1,	61,	-1,	-1,	"a/D<+>o/'.'D<+>//' '/A<+>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	54,	52,	-1,	60,	-1,	-1,	"A<+>r/'-'/' dash '/S{A<+>D<+>,D<+>A<+>}<1>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	55,	52,	-1,	-1,	-1,	-1,	"D<+>r/'-'/' dash '/A<+>D<+>W~<*>"	},
{	0,	-1,	0x7FFF,	0x7FFF,	56,	52,	-1,	-1,	-1,	-1,	"D<+>o/'.'D<+>/b/a/'-'/' '//' '/D<+>W~<*>"	},
{	1,	0,	0x0000,	0x0000,	57,	 0,	 0,	 0,	 0,	 0,	""	},
