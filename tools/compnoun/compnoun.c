...
//	dump_dictionary(head,end);
	...
	memset(temp_chars,0,count_chars);
...
{	
	...
	fprintf(outfile," *    Digital Equipment Corporation 1996, 1997, 1998. All rights reserved.\n");
	fprintf(outfile," *\n");
...
int add_entry_to_table(compiler_table_entry *head,unsigned char *input_string)
{
