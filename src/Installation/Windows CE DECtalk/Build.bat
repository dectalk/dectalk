...
set INSTALLPROJECT=D:\work\rnd\Installation\Windows CE DECtalk\Windows CE DECtalk.ipr
set CURRENTBUILD=Windows CE
...
set INCLUDESCRIPT=D:\work\rnd\Installation\Windows CE DECtalk\Script Files
...
set RULFILES=D:\work\rnd\Installation\Windows CE DECtalk\Script Files\setup.rul
