...
!MESSAGE No configuration specified. Defaulting to WTTSDTLK - WIN32 RELEASE.
!ENDIF 

!IF "$(CFG)" != "wttsdtlk - Win32 Release" && "$(CFG)" != "wttsdtlk - Win32 Debug" && "$(CFG)" != "wttsdtlk - Win32 Release Spanish" && "$(CFG)" != "wttsdtlk - Win32 Release German" && "$(CFG)" != "wttsdtlk - Win32 Release Latin American" && "$(CFG)" != "wttsdtlk - Win32 Debug Spanish" && "$(CFG)" != "wttsdtlk - Win32 Debug German" && "$(CFG)" != "wttsdtlk - Win32 Debug Latin American" && "$(CFG)" != "wttsdtlk - Win32 Release United Kingdom" && "$(CFG)" != "wttsdtlk - Win32 Debug United Kingdom"
