...
struct rule_struct_comp
{
  ...
  S16 copy_hit;							 /* new copy hit rule thing for german phone numbers */	
...
//#define _BIGENDIAN_
#ifdef _BIGENDIAN_
#define set_short(ptr,val) ((((U8 *)(ptr))[1] = (((U16)(val)) ) & 0x00ff), \
		            (((U8 *)(ptr))[0] = (((U16 )(val)) >> 8 ) & 0x00ff))
#else
...
#ifdef _BIGENDIAN_
#define set_int(ptr,val) ((((U8 *)(ptr))[3] = (((U32)(val)) ) & 0x000000ff), \
		            (((U8 *)(ptr))[2] = (((U32)(val)) >> 8 ) & 0x000000ff), \
					(((U8 *)(ptr))[1] = (((U32)(val)) >> 16 ) & 0x000000ff), \
		            (((U8 *)(ptr))[0] = (((U32)(val)) >> 24 ) & 0x000000ff))
#else
#define set_int(ptr,val) ((((U8 *)(ptr))[0] = (((U32)(val)) ) & 0x000000ff), \
		            (((U8 *)(ptr))[1] = (((U32)(val)) >> 8 ) & 0x000000ff),  \
					(((U8 *)(ptr))[2] = (((U32)(val)) >> 16 ) & 0x000000ff), \
		            (((U8 *)(ptr))[3] = (((U32)(val)) >> 24 ) & 0x000000ff))
#endif
