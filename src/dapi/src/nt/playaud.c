...
#if defined __linux__ || defined VXWORKS || defined __EMSCRIPTEN__ || defined (__APPLE__)
...
{
#if !defined _WIN32 && !defined __linux__ && !defined VXWORKS && !defined _SPARC_SOLARIS_ && !defined __EMSCRIPTEN__ || defined (__APPLE__) // NAL warning removal
  LPDWORD pdwVol;
#endif
...
#if defined _WIN32 || defined __linux__ || defined VXWORKS || defined _SPARC_SOLARIS_ || defined __EMSCRIPTEN__ || defined (__APPLE__)
