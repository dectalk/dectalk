 ...
 ***********************************************************************
 *    Revision History:
 * 001	86			Michel  INITIAL VERSION FOR FRENCH
 * 002	07-05-92	Michel  Clean up file
 * 003	29-08-94	Michel  Reduce GF for feminine voices; need a femamp table
 *                  Michel  BR = 0 for test
 * 004	31-08-94	WIH     Added definitions for 8 kHz. sample rate.
 * 005	07-20-00	CHJ		Renamed from fphvdef.c to p_fr_vdf1.c, #include's updated. 8khz speaker defs
 *							are lies.
 * 006	09-20-00	CAB		Fixed copyright info and format revision section
 * 007	02-09-01	CAB		Added Michel changes for French
 * 008	04-06-01	eab		Check in french la change and verifry tuning fo 4.61
 * 009	08-31-01	CAB		Added ifdef NEW_PHONES
 */
...
const short paul [SPDEF] = {
	MALE,   /* SEX = m */
	 ...
	 100,   /* PR (pitch range in percent of Paul's range) */
	  ...
	  30,   /* RI (was 45,Richness in %, actually nopen is 100-RI % of T0) */
	...
	4800,   /* F5 (was 3900, frequency in Hz of cascade 5th formant = F5*100/HS) */
	 330,   /* B5 (was 180, bandwidth in Hz of cascaded 5th formant) */
	3450,   /* F7 (frequency in Hz of parallel 4th formant = F7) */
	4850,   /* F8 (frequency in Hz of parallel 5th formant = F8) */
#ifdef HLSYN
	  ...
	  35,   /* FT (f0-dependent spectral tilt in % of max) */
...
const short kit_8[SPDEF] = {
	...
	ZAPF,   /* F8 (frequency in Hz of parallel 5th formant = F8) */
	  62,   /* GF was 72 (gain of frication source in dB) */
