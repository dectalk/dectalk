...
/*A */ {  0, 0, 0, 0, 0, 0, 0,64, 0, 650,1360,2590,290,180, 90,200 },//A 
...
/*I */ {  0, 0, 0, 0, 0, 0, 0,63, 0, 330,2500,3000,290,150,130,200 },//I 
...
/*U */ {  0, 0, 0, 0, 0, 0, 0,62, 0, 310,1850,2310,290, 80, 90,180 },//U 
/*An*/ {  0, 0, 0, 0, 0, 0,50,64, 6, 730, 950,2590,390,100,180,250 },//An
/*In*/ {  0, 0, 0, 0, 0, 0,45,64, 6, 730,1500,2580,350,300,100,250 },//In
/*On*/ {  0, 0, 0, 0, 0, 0,40,65, 6, 430, 900,2400,350,300,100,200 },//On
/*Un*/ {  0, 0, 0, 0, 0, 0,55,64, 6, 640,1440,2370,350,160,100,200 },//Un
#ifdef HLSYN  // Michel
/*Ap*/ {  0, 0, 0, 0, 0, 0, 0,40,20, 430,1500,2500,290,120, 60,120 },//Ap
#else
/*Ap*/ {  0, 0, 0, 0, 0, 0, 0,55,20, 430,1500,2500,290,120, 60,120 },//Ap
#endif
//       A2 A3 A4 A5 A6 AB AH AV TLT  F1   F2   F3 FNZ  B1  B2  B3
/*L */ {  0, 0, 0, 0, 0, 0, 0,60, 0, 350,1830,2600,290, 55, 80,220 },//L 
/*R */ { 40,30,35,30, 0, 0, 0, 0, 0, 600, 800,2400,290,140,200,250 },//R 
...
/*Ch*/ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 350,1950,2500,290,200,280,250 },//Ch
/*F */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 340,1800,2600,290,200,300,150 },//F 
/*J */ {  0, 0, 0, 0, 0, 0, 0, 0,40, 300,1800,2400,290,320,140,250 },//J 
/*Rx*/ {  0, 0, 0, 0, 0, 0, 0, 0, 0, 800,1200,2500,290,250,220,250 },//Rx
/*S */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 320,1420,2550,290,200,180,300 },//S 
/*V */ {  0, 0, 0, 0, 0, 0, 0,53, 7, 280,1400,2480,290,100,120,120 },//V 
...
/*P */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 200,1370,2050,290,200,180,250 },//P 
/*T */ {  0, 0, 0, 0, 0, 0, 0, 0, 7, 350,1700,2700,290,200,150,250 },//T 
/*Gn*/ {  0, 0, 0, 0, 0, 0, 0,52, 6, 330,2350,3050,400,100,200,380 },//Gn
/*M */ {  0, 0, 0, 0, 0, 0, 0,60, 6, 300,1500,2400,400,130,300,130 },//M 
/*N */ {  0, 0, 0, 0, 0, 0, 0,60, 6, 300,1900,2800,400,200,200,200 },//N 
/*Ng*/ {  0, 0, 0, 0, 0, 0, 0,60, 6, 180,1440,2350,400,160,150,100 } //Ng
...
/*fOu*/ {  0, 0, 0, 0, 0, 0, 0,64, 6, 300, 800,2100,290, 80, 90,150 },/*Ou*/
...
/*fAp*/ {  0, 0, 0, 0, 0, 0, 0,45-10, 10, 430,1500,2500,290,120, 120,120 },/*Ap*/
...
/*fY */ {  0, 0, 0, 0, 0, 0, 0,56, 6, 230,2370,2570,290, 50,200,300 },/*Y */
...
/*fB */ {  0, 0, 0, 0, 0, 0, 0, 0,20, 210,1100,2150,290, 90, 80,130 },/*B */
/*fD */ {  0, 0, 0, 0, 0, 0, 0,45,20, 210,1733,2880,290, 90,100,240 },/*D */
/*fG */ {  0, 0, 0, 0, 0, 0, 0, 0,20, 210,1790,2520,290, 90,120,180 },/*G */
/*fK */ {  0, 0, 0, 0, 0, 0, 0, 0,13, 350,1790,2250,290,200,160,280 },/*K */
/*fP */ {  0, 0, 0, 0, 0, 0, 0, 0,13, 200,1370,2050,290,200,180,250 },/*P */
...
const short fr_maleloc[] = {
  ...
  280,40,45,   2350,0,60,    3000, 50,60,  //  37 : Gn front
  280,40,45,   2350,20,60,   3000, 50,60,  //  46 : Gn not used
  280,40,45,   2350,20,60,   3000, 50,60,  //  55 : Gn not used
  280,40,45,   2350,20,60,   3000, 50,60,  //  64 : Gn not used
  ...
  320,54,55,   1950,25,70,   2750, 19,70,  // 271 : Ch front
  320,54,55,   1680,10,70,   2000, 10,70,  // 280 : Ch back-unrounded
  320,54,55,   1680,10,90,   2350, 10,100, // 289 : Ch rounded

  240,32,55,   1750,55,70,   2750, 19,70,  // 298 : J front
  245,32,55,   1580,20,50,   2450, 10,70,  // 307 : J back-unrounded
  245,32,55,   1680,10,90,   2350, 10,100, // 316 : J rounded

  470,30,30,   1500,25,35,   2600, 30,40,  // 325 : M front
  450,20,30,   1000,20,40,   1550, 80,25,  // 334 : M back et rounded

  450,20,35,   1800,30,50,   3000, 25,65,  // 343 : N front
  450,20,30,   1600,20,75,   2600,  0,60,  // 352 : N back-unrounded
  450,20,30,   1800,15,95,   2820,  0,95,  // 361 : N rounded
...
// Parallel amplitudes for obstruents before front, back, round, and nonsonor :
//   A2   A3   A4   A5   A6   AB
// burst is flat for [P] and [B]
#if OUT
