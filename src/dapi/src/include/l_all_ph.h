...
#if defined(VOICE_ROM_DTC_03_03JAN89) || defined(VOICE_ROM_DECTALK_41)
#define US_TOT_ALLOPHONES	56
#undef US_DF
#define US_DF US_T
#elif defined(VOICE_ROM_DECTALK_43) || defined(VOICE_ROM_DECTALK_1996M_43F) || defined(VOICE_ROM_DECTALKEXPRESS_42CD)
