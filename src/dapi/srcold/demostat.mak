...
OUTDIR=.\..\build\demostat\uk\release
INTDIR=.\..\build\demostat\uk\release\link
# Begin Custom Macros
OutDir=.\..\build\demostat\uk\release
# End Custom Macros
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I ".\api" /I ".\acna" /I ".\lts" /I ".\vtm" /I ".\ph" /I ".\kernel" /I ".\nt" /I ".\cmd" /I ".\include" /I ".\protos" /I "..\.." /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "BLD_DECTALK_DLL" /D "ENGLISH_UK" /D "ENGLISH" /Fp"$(INTDIR)\demostat.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\demostat.bsc" 
BSC32_SBRS= \
...
OUTDIR=.\..\build\demostat\uk\debug
INTDIR=.\..\build\demostat\uk\debug\link
# Begin Custom Macros
OutDir=.\..\build\demostat\uk\debug
# End Custom Macros
...
CPP_PROJ=/nologo /MTd /W3 /GX /Z7 /O2 /I ".\api" /I ".\acna" /I ".\lts" /I ".\vtm" /I ".\ph" /I ".\kernel" /I ".\nt" /I ".\cmd" /I ".\include" /I ".\protos" /I "..\.." /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "BLD_DECTALK_DLL" /D "ENGLISH_UK" /D "ENGLISH" /Fp"$(INTDIR)\demostat.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\demostat.bsc" 
BSC32_SBRS= \
